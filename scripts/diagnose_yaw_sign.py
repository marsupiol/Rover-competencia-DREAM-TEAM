...
Uso:
  python3 scripts/diagnose_yaw_sign.py --burst --w 0.70 --duration 1.0
  python3 scripts/diagnose_yaw_sign.py --monitor --duration 10.0
"""
...
def run_diagnostic(args):
    ...
    #
    # Comando de giro w:
    # Si invert_angular=True en el controlador, w=+0.70 envía -0.70 a cmd_vel o viceversa.
