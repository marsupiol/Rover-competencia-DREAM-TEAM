...
def test_accel_scale_factor_opens_tilt_gate(ros_context):
    ...
    Con muestras sintéticas de |a| = 1.966g y accel_scale_factor=0.5090 aplicado,
    verificar que el gate del filtro complementario abre (gate_open=True, duty_cycle_pct sube)."""
    ...
    # Datos sintéticos de telemetría basados en el dump en reposo (|a| ~ 1.966g)
    synthetic_telemetry = {
        "mags": [[10.0, 20.0, 30.0]],
        "gyros": [[-5.24, -0.90, 0.12]],
        "accels": [
            [0.036, 0.004, -1.966],
            [0.033, -0.001, -1.959],
            [0.033, -0.004, -1.969],
    ...
    # Verificar que con scale_factor 0.5090, mean_norm_g está alrededor de 1.0g
